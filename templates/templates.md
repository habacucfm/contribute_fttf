...
```
## Warning in readLines("data.csv"): incomplete final line found on 'data.csv'
```
...
[Download the template for study contact information](data:text/csv;base64,bmFtZSxlbWFpbCxhZGRyZXNzCllvdXIgbmFtZSx5b3VyZW1haWxhZHJlc3NAc29tZXdoZXJlLmVkdSxQaHlzaWNhbCBhZGRyZXNz) **or** open it directly in your  <a download="dataMatchColumns.csv" href="data:application/csv;base64,bmFtZSxlbWFpbCxhZGRyZXNzCllvdXIgbmFtZSx5b3VyZW1haWxhZHJlc3NAc29tZXdoZXJlLmVkdSxQaHlzaWNhbCBhZGRyZXNz">browser</a>
